...
const chartConfig = {
  ...
  // Map series keys to semantic labels regardless of data origin
  desktop: {
    label: "Events",
...
export function ChartAreaInteractive({
  ...
  // Don't use fallback data if we're still loading
    ...
    <Card className="@container/card">
      <CardHeader className="relative">
        <CardTitle className="text-white">
          {labels?.title ?? "Platform Activity"}
        </CardTitle>
        <CardDescription className="text-white/60">
          <span className="@[540px]/card:block hidden">
            {labels?.description ?? "Events vs Users for the selected range"}
          </span>
          <span className="@[540px]/card:hidden">
            {labels?.description ?? "Events vs Users"}
          </span>
        </CardDescription>
                ...
                content={
                  <ChartTooltipContent
                    ...
                    formatter={(val: unknown, name: unknown) => {
                      const mapped = name === "desktop" ? "Events" : "Users";
                      return (
                        <>
